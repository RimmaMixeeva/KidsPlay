...
@Composable
fun StroopGameSecondLevelsScreen(viewModel: StroopEffectGameViewModel) {
        ...
        if (stroopLevels.value.size > 29) {
            LazyVerticalGrid(
                ...
                items(15) { i ->
                    StroopEffectLevel(
                        {
                            if (stroopLevels.value[i + 15].isLevelOpened) {
                                viewModel.startLevel(stroopLevels.value[i+15].levelNumber)
                            }
                        },
                        stroopLevels.value[i + 15]
                    )
                }
            }
        }
