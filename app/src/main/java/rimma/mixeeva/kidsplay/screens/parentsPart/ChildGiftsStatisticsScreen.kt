            ...
            Row(modifier = Modifier.horizontalScroll(rememberScrollState())) {
                Column{
                    ...
                    Column(
                        ...
                        viewModel.currentChildGiftsList.forEach { gift ->
                            Row(
                                ...
                                Spacer(modifier = Modifier.width(4.dp))
                                Icon(
                                    imageVector = if (gift.opened) Icons.Default.Check else Icons.Default.Close,
                                    contentDescription = if (gift.used) "yes" else "no",
                                    tint = if (gift.opened) DarkGreen else Color.Red,
                                    modifier = Modifier
                                        .padding(4.dp)
                                        .width(150.dp)
                                        .size(40.dp),
                                ...
                                Spacer(modifier = Modifier.width(4.dp))
                                Icon(
                                    imageVector = if (gift.used) Icons.Default.Check else Icons.Default.Close,
                                    contentDescription = if (gift.used) "yes" else "no",
                                    tint = if (gift.used) DarkGreen else Color.Red,
                                    modifier = Modifier
                                        .padding(4.dp)
                                        .width(150.dp)
                                        .size(40.dp),
