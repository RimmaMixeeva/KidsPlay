...
@Composable
fun StropGameFirstLevelsScreen(viewModel: StroopEffectGameViewModel) {
        ...
        if (stroopLevels.value.size > 14) {
            LazyVerticalGrid(
                ...
                items(15) { i ->
                    StroopEffectLevel(
                        {
                            if (stroopLevels.value[i].isLevelOpened) {
                                viewModel.startLevel(stroopLevels.value[i].levelNumber)
                            }
                        },
                        stroopLevels.value[i]
                    )
                }
            }
        }
