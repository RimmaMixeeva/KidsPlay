...
@Composable
fun ColorGameFourthLevelsScreen(viewModel: ColorGameViewModel) {
        ...
        if (colorLevels.value.size > 59) {
            LazyVerticalGrid(
                ...
                items(15) { i ->
                    ColorLevel(
                        {
                            if (colorLevels.value[i + 45].isLevelOpened) {
                                viewModel.startLevel(colorLevels.value[i + 45].levelNumber)
                            }
                        },
                        colorLevels.value[i + 45]
                    )
                }
            }
        }
